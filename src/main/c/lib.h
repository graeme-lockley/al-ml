...
extern struct Value *_not_equals(struct Value *op1, struct Value *op2);
extern struct Value *_less_than(struct Value *op1, struct Value *op2);
extern struct Value *_less_equal(struct Value *op1, struct Value *op2);
extern struct Value *_greater_than(struct Value *op1, struct Value *op2);
extern struct Value *_greater_equal(struct Value *op1, struct Value *op2);
